...
public class SingerDetailActivity extends AppCompatActivity {
    ...
    private TextView sBirthday;
    private TextView sNation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songImage = (ImageView) findViewById(R.id.dt_singer_pl_image);
        ...
        sBirthday = (TextView) findViewById(R.id.singer_birth);
        sNation = (TextView) findViewById(R.id.singer_nation);
        ...
        preButton = (ImageView) findViewById(R.id.dt_singer_pl_prev);
        nextButton = (ImageView) findViewById(R.id.dt_singer_pl_next);
        ...
        if (b != null) {
            singerID = b.getLong("id");
            singerName = b.getString("name");
            this.setTitle(singerName);
            String name = singerName;
            String birhday = b.getString("birth");
            ...
            if (!name.equals("null") && name != null)
                sName.setText(name);
            if (!birhday.equals("null") && birhday != null)
                sBirthday.setText(birhday);
            if (!nation.equals("null") && nation != null)
                sNation.setText(nation);
            if (!detail.equals("null") && detail != null)
                sDetail.setText(detail);
        }
        ...
        AsyncAlbumSong asyncAlbumSong = new AsyncAlbumSong(new AsyncListener() {
            ...
            public void onAsyncComplete() {
                LinearLayout listSong = (LinearLayout) findViewById(R.id.song_singer);
                SongListAdapter data = new SongListAdapter
                        (SingerDetailActivity.this, MediaManager.getInstance().getPrepareList());
                AddSongListLinearL(listSong, data);
            }
        });
        asyncAlbumSong.execute(String.format(GET_SONG_BY_SINGER, singerID, page));
        ...
        AsyncAlbum asyncAlbum = new AsyncAlbum(new AsyncListener() {
            ...
            public void onAsyncComplete() {
                ...
                RecyclerView albumView = (RecyclerView) findViewById(R.id.album_singer);

                albumView.setHasFixedSize(true);
                layoutManager = new GridLayoutManager(SingerDetailActivity.this, 2);
        ...
        asyncAlbum.execute(String.format(GET_ALBUM_BY_SINGER, singerName, page));
    }
