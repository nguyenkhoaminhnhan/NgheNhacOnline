...
public class HotSongAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.name = (TextView) convertView.findViewById(R.id.hot_song_name);
            holder.singer = (TextView) convertView.findViewById(R.id.hot_song_singer);
            holder.image = (ImageView) convertView.findViewById(R.id.hot_song_image);
