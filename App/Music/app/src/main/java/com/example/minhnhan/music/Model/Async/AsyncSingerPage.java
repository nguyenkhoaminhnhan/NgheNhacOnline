...
public class AsyncSingerPage extends AsyncTask<String, String, String> {
    private AsyncListener listener;

    public AsyncSingerPage(AsyncListener listener) {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            DataManager.getInstance().setSingerPage(new SingerPage(object));
